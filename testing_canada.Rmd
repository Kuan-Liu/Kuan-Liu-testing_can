...
- **Highlights**
  ...
  - **Quebec has rapidly increased its testing capacity. The total number of tests per 100,000 population has increased to 889 (top 2) as of Apr 1, 2020, comparing to 365 on Mar 25, 2020.**
...
#Province plot;
testing_cum2<-subset(testing_cum, Province %in% c("AB","BC","MB","NB","NL","NS","ON","PE","QC","SK")& dateformat > as.Date("2020-03-19") & dateformat < as.Date("2020-04-01"))
...
#Territory plot;
testing_cumt<-subset(testing_cum, Province %in% c("NU","YT","NT") & dateformat > as.Date("2020-03-19") & dateformat < as.Date("2020-04-01"))
...
- **Highlights**
  ...
  - **Newfoundland and Labrador has the highest proportion of positive tests (6.2%). This can be interpreted as for every 100 tests completed (with known results) in Newfoundland and Labrador, we expect around 6 of them to be postive.**
  - **There appears to be a back log of test reporting in Prince Edward Island and Nunvaut. HThe back log in Ontario is observed to be decreasing. The proportion of pending tests in Ontario has reduced to 5.4% comparing to the same proportion on Mar 25, 2020 at 29.4%.**
