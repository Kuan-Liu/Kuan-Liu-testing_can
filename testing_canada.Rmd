...
- **Highlights**
  ...
  - **Northwest territories reported over 3000 tests per 100,000 population, highest in Canada.**
...
ggplot(testing_todate, aes(x=total_adjp, y=`Total cases per 100,000`, colour=Province)) +
  ...
  annotate(geom="text", x=500, y=250, label=paste("national test-case ratio at ", TCR_CAN*100 ,"%"),
              color="red") +
...
geom_line(size = 1)+geom_point()+
  ...
  scale_y_continuous(limits = c(0, 2500), breaks = seq(0,2500,200))+
  scale_color_manual(values=teamcolour_province)+
  scale_x_date(date_breaks="1 day",date_labels="%b %d")+
...
- **Highlights**
  ...
  - **Quebec has the highest proportion of positive tests (11.3%).**
