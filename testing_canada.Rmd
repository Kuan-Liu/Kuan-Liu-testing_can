...
ggplot(testing_todate, aes(x=total_adjp, y=`Total cases per 100,000`, colour=Province)) +
  ...
  annotate(geom="text", x=500, y=320, label=paste("national test-case ratio at ", TCR_CAN*100 ,"%"),
              color="red") +
  scale_x_continuous(limits = c(0, 2500), breaks = seq(0,2500,500))+
  scale_y_continuous(limits = c(0, 320), breaks = seq(0,320,20))+
...
geom_line(size = 1) + 
  geom_point() +
  scale_y_continuous(limits = c(0, 260000), breaks = seq(0, 260000, 20000)) +
...
- **Highlights**
  ...
  - **Quebec has the highest proportion of positive tests (12.4%).**
