...
As of March 27, 2020 (11 am EDT), the total number of patients tested in Canada is 164,564 and the total number of patients tested per 10,000 population in Canada is around 42.

  - the total number of patients tested positive is 4,285 (2.6%)
  - the total number of patients tested negative is 147,405 (89.6%)
  - the rest 12,874 patients (7.8%) are likely under investigation waiting for test results, detailed information is not available.
...
- **Highlights**
  ...
  - **Quebec has rapidly increased their testing capacity. The total number of tests per 10,000 population has increased to 49 as of Mar 27, 2020 comparing to 37 on Mar 25, 2020.**
...
kable(testing_todate[,1:7], caption = "Reported testing data province and territory, public data accessed online as of March 27, 2020 (8 pm EDT). Reported positive tests include resolved and deceased cases.")
```

###### Footnote: It's likely individuals may have been tested more than once. We are collecting publicly avaliable information online to best match patients with testing numbers. Unfortunately, detailed information is not always avaiable, so please read these data with caution.
...
>>>>>>> 1cd24abcd2dafa63bc4662b02113649a4aa09fba
...
library(forcats)
testprop_cum <- mutate(testprop_cum, fct_relevel())
data %>%
