...
names(testing_todate)[1:7]<-c("Province ","Reported Positive","Reported Negative","Reported Pending","Total","Est. Population","Total per 10,000 population")
...
testing_todate_p<-testing_todate_p[order(testing_todate_p$`Total per 10,000 population`, decreasing = TRUE),]
testing_todate_t<-testing_todate_t[order(testing_todate_t$`Total per 10,000 population`, decreasing = TRUE),]
names(testing_todate_t)[1:7]<-c("Territory","Reported Positive","Reported Negative","Reported Pending","Total","Est. Population","Total per 10,000 population")
