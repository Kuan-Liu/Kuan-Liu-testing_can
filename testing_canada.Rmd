...
ggplot(testing_todate, aes(x=total_adjp, y=`Total cases per 100,000`, colour=Province)) +
  ...
  annotate(geom="text", x=1000, y=550, label=paste("national test-case ratio at ", TCR_CAN*100 ,"%"),
              color="red") +
  scale_x_continuous(limits = c(0, 5500), breaks = seq(0,5500,500))+
...
geom_line(size = 1) + 
  geom_point() +
  scale_y_continuous(limits = c(0, 580000), breaks = seq(0, 580000, 20000)) +
...
geom_line(size = 1)+geom_point()+
  ...
  scale_y_continuous(limits = c(0,5200), breaks = seq(0,5200,200))+
  scale_color_manual(values=teamcolour_province)+
  scale_x_date(date_breaks="1 day",date_labels="%b %d")+
