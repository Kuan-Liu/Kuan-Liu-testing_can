...
ggplot(testing_todate, aes(x=total_adjp, y=`Total cases per 100,000`, colour=Province)) +
  ...
  annotate(geom="text", x=500, y=300, label=paste("national test-case ratio at ", TCR_CAN*100 ,"%"),
              color="red") +
...
geom_line(size = 1) + 
  geom_point() +
  scale_y_continuous(limits = c(0, 230000), breaks = seq(0, 230000, 10000)) +
...
- **Highlights**
  ...
  - **Quebec has the highest proportion of positive tests (12.2%).**
