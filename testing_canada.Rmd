...
testing_todate_p<-testing_todate[testing_todate$Province %in% c("AB","BC","MB","NB","NL","NS","ON","PEI","QC","SK"),]
testing_todate_t<-testing_todate[testing_todate$Province %in% c("NWT","YT","NU"),]

testing_todate_p<-testing_todate_p[order(testing_todate_p$`Total per 10,000 people`, decreasing = TRUE),]
testing_todate_t<-testing_todate_t[order(testing_todate_t$`Total per 10,000 people`, decreasing = TRUE),]

testing_todate<-rbind(testing_todate_p,testing_todate_t)

kable(testing_todate[,1:7], caption = "Reported testing data province and territory, public data accessed online as of March 27, 2020 (8 pm EDT). Reported positive tests include resolved and deceased cases.", row.names = FALSE)
```
