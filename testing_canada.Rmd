...
ggplot(testing_todate, aes(x=total_adjp, y=`Total cases per 100,000`, colour=Province)) +
  ...
  annotate(geom="text", x=800, y=420, label=paste("national test-case ratio at ", TCR_CAN*100 ,"%"),
              color="red") +
  scale_x_continuous(limits = c(0, 4300), breaks = seq(0,4300,500))+
  scale_y_continuous(limits = c(0, 420), breaks = seq(0,420,20))+
...
geom_line(size = 1) + 
  geom_point() +
  scale_y_continuous(limits = c(0, 370000), breaks = seq(0, 370000, 20000)) +
...
- **Highlights**
  ...
  - **Quebec has the highest proportion of positive tests (13.4%).**
