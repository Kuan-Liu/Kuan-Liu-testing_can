...
geom_line(size = 1) + 
  geom_point() +
  scale_y_continuous(limits = c(0, 150000), breaks = seq(0, 150000, 10000)) +
...
- **Highlights**
  ...
  - **Quebec has the highest proportion of positive tests (10.2%).**
  - **There appears to be a back log of test reporting in Nunvaut. The back log in Ontario is observed to be cleared. The proportion of pending tests in Ontario has reduced significantly, at less than 2% now comparing to the same proportion on Mar 25, 2020 at 29.4%.**
