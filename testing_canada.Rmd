...
geom_line(size = 1)+
  scale_y_continuous(limits = c(0, 42500), breaks = seq(0,42500,2500))+
...
geom_line(size = 1)+geom_point()+
  scale_y_continuous(limits = c(100, 650), breaks = seq(100,650,50))+
...
geom_line(size = 1)+geom_point()+
  scale_y_continuous(limits = c(100, 1500), breaks = seq(100,1500,100))+
  scale_fill_manual(name="Province")+
  scale_x_date(date_breaks="1 day",date_labels="%m-%d")+
  labs(y="\n Total number of cumulative tests per 100,000 population \n by territory", x="")+
  theme(panel.background = element_rect(fill = "white", colour = "white"),
...
grid.arrange(p_testcumt, p_testcumpt, nrow=1,widths = c(0.43,0.57))
