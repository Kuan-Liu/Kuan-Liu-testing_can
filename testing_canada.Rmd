...
ggplot(testing_todate, aes(x=total_adjp, y=`Total cases per 100,000`, colour=Province)) +
  ...
  annotate(geom="text", x=800, y=450, label=paste("national test-case ratio at ", TCR_CAN*100 ,"%"),
              color="red") +
  scale_x_continuous(limits = c(0, 4300), breaks = seq(0,4300,500))+
  scale_y_continuous(limits = c(0, 450), breaks = seq(0,450,25))+
...
geom_line(size = 1) + 
  geom_point() +
  scale_y_continuous(limits = c(0, 400000), breaks = seq(0, 400000, 20000)) +
...
geom_line(size = 1)+geom_point()+
  ...
  scale_y_continuous(limits = c(0, 4200), breaks = seq(0,4200,200))+
  scale_color_manual(values=teamcolour_province)+
  scale_x_date(date_breaks="1 day",date_labels="%b %d")+
...
- **Highlights**
  ...
  - **Quebec has the highest proportion of positive tests (13.3%).**
