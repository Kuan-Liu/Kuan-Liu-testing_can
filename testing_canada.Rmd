...
As of March 28, 2020 (10 pm EDT), the total number of patients tested in Canada is **184,201** and the total number of patients tested per 100,000 population in Canada is around **490**.
...
#### Geographic mapping on the total number of tests, total number of cases, total number of tests per 100,000 population and total number of cases per 100,000 population as of Mar 28, 2020
...
- **Highlights**
  ...
  - **There appears to be a back log of test reporting in Ontario and Prince Edward Island. However the back log in Ontario is observed to be decreasing. The proportion of pending tests in Ontario on Mar 28, 2020 is 20.2% comparing to the same proportion on Mar 25, 2020 at 29.4%.**
...
geom_line(size = 1)+geom_point()+
  scale_y_continuous(limits = c(0, 54000), breaks = seq(0,55000,5000))+
...
geom_line(size = 1)+geom_point()+
  ...
  scale_y_continuous(limits = c(0, 1800), breaks = seq(0,1800,250))+
  scale_color_manual(values=teamcolour_territory)+
  scale_x_date(date_breaks="1 day",date_labels="%b %d")+
...
- **Highlights**
  ...
  - **Given the most recent data, Quebec completes on average 10,000 tests per day. British Columbia and Alberta complete on average 4,000 to 5,000 tests per day. Ontario completes around 2,000, to 3,000 tests per day.**
...
#Province plot;
testing_cum2<-subset(testing_cum, Province %in% c("AB","BC","MB","NB","NL","NS","ON","PE","QC","SK")& dateformat > as.Date("2020-03-19") & dateformat < as.Date("2020-03-28"))
