...
map_test_p = tm_shape(testing_data)+tm_polygons(col="test_pop",style = "cont", title="")+tm_layout(title="Tests per 100,000", title.size = 1,title.position=c("left","bottom"),legend.position = c("right","top"))
map_case_p = tm_shape(testing_data)+tm_polygons(col="case_pop",style = "cont", title=" ")+tm_layout(title="Cases per 100,000", title.size = 1,title.position=c("left","bottom"),legend.position = c("right","top"))
# tmap_arrange(map_test_p, map_case_p,nrow=1)

map_test = tm_shape(testing_data)+tm_polygons(col="test",style = "cont", title=" ")+tm_layout(title="Tests", title.size = 1,title.position=c("left","bottom"),legend.position = c("right","top"))
map_case = tm_shape(testing_data)+tm_polygons(col="case",style = "cont", title=" ")+tm_layout(title="Cases", title.size = 1,title.position=c("left","bottom"),legend.position = c("right","top"))
...
ggplot(testprop_plot, aes(x = province, y = value, fill = variable, label = value)) +
  ...
  geom_text(size = 3, position = position_stack(vjust = 0.5),vjust=-1, na.rm=TRUE) + coord_flip() +
...
geom_line(size = 1)+
  ...
  scale_x_date(date_breaks="1 day",date_labels="%m-%d", 
               limits = c(min(testing_cum2$dateformate), max(testing_cum2$dateformate) + 0.25)) +
