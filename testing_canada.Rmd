...
geom_line(size = 1) + 
  geom_point() +
  scale_y_continuous(limits = c(0, 360000), breaks = seq(0, 360000, 20000)) +
...
topp<-ggplot(testing_cum_top, aes(x=dateformat, y=est_daily2, colour=Province)) +
  ...
  scale_y_continuous(limits = c(0, 17200), breaks = seq(0,17200,1000))+
...
- **Highlights**
  ...
  - **Quebec has the highest proportion of positive tests (13.7%).**
